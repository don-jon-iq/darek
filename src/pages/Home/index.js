...
function Home() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "welcom-logo", ref: logowelcom, children: _jsx(Logo, {}) }), _jsxs("div", { className: "container", ref: container, children: [_jsxs("div", { className: 'contant', children: [_jsx(Bg, {}), _jsxs("div", { className: "menu-container", children: [_jsx(Menu, { pMenu: 'm1' }), _jsx(Menu, { pMenu: 'm2' }), _jsx(Menu, { pMenu: 'm3' })] })] }), _jsx(Navbar, {})] })] }));
}
export default Home;
